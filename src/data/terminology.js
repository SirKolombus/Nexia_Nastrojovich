/*
 * Terminology data structure for financial audit add-in (JavaScript version)
 */
          ...
          entries: [
            ...
            },
            {
              ...
              examples: [
                ...
                "Odmítnutí výroku - auditor nebyl schopen získat dostatečné důkazy k vydání názoru na účetní závěrku."
              ],
            },
            {
...
export function searchTerminology(query, data) {
  const results = [];
...
export function getTerminologyById(id, data) {
